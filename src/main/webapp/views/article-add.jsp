	...
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="priority" type="radio" value="高">
					<label>高</label>
				</div>
				<div class="radio-box">
					<input name="priority" type="radio" value="中">
					<label>中</label>
				</div>
				<div class="radio-box">
					<input name="priority" type="radio" value="低">
					<label>低</label>
				</div>
			</div>
		</div>
		...
		<input type="hidden" id="addUserId" value="${userId}">
	</form>
</article>
...
$(function(){
    ...
    $("#form-article-add").validate({
        ...
        submitHandler:function(form){
            $.ajax({
                type : "POST",
                url : "${APP_PATH}/item/addItem/"+ ${userId},
